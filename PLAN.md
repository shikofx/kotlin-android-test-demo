...
*   [ ] **Задачи по CI/CD (GitHub Actions & GitLab CI):*
    *   **Интеграция с Allure Report:**
        ...
        *   [ ] Настроить пайплайн в **GitLab CI** для генерации Allure-отчета и его публикации на **GitLab Pages**.
        *   [ ] Обновить `pages` job в GitLab для включения отчетов о покрытии и Allure в общий отчет.
        *   **Настройка JaCoCo:**
        *   [ ] Интегрировать JaCoCo в Gradle для сбора покрытия кода тестами.
        *   [ ] Добавить в CI-пайплайны задачу для генерации отчета JaCoCo и сохранения его как артефакта.
