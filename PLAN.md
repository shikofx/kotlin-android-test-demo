...
*   [ ] **Задачи по CI/CD (GitLab CI):**
    *   **Развертывание GitLab:**
        ...
        *   [x] Установить GitLab (Community Edition) на арендованном сервере.
    *   **Подготовка образа:**
        *   [ ] Создать `Dockerfile` для сборки Android-проекта, включающий нужную версию JDK и Android SDK.
        *   [ ] Настроить `Container Registry` в GitLab для хранения Docker-образа.
    *   **Настройка Runner'а:**
        *   [ ] Установить и зарегистрировать GitLab Runner на арендованном сервере (Beget).
        *   [ ] Настроить раннер для использования Docker-executor'а.
