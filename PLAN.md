...
## Этап 2: Модульное тестирование, сбор покрытия и отчетность (01.10 - 08.10)

**Цель:** Написать первые модульные тесты, настроить сбор покрытия кода и интегрировать **Allure Report** для визуализации результатов.
...
*   [x] **Задачи по CI/CD (GitHub Actions & GitLab CI):*
    *   **Интеграция с Allure Report:**
        *   [x] Добавить плагин Allure в Gradle.
        *   [x] Настроить пайплайн в **GitHub Actions** для генерации Allure-отчета и его публикации на **GitHub Pages**.
        *   [x] Настроить пайплайн в **GitLab CI** для генерации Allure-отчета и его публикации на **GitLab Pages**.
    *   **Настройка JaCoCo:**
        *   [x] Интегрировать JaCoCo в Gradle для сбора покрытия кода тестами.
        *   [x] Добавить в CI-пайплайны задачу для генерации отчета JaCoCo и сохранения его как артефакта.
    *   [x] Обновить `pages` job в GitLab для включения отчетов о покрытии и Allure в общий отчет.

*   [ ] **Задачи по коду (продолжение):**
    *   [ ] Расширить покрытие Unit-тестами для ViewModel и других компонентов, используя **MockK** и **Truth**.
*   [ ] **Финализация:**
    *   [ ] Выполнить слияние ветки `feature/2-unit-tests` в `develop`.

## Этап 3: Рефакторинг бизнес-логики (09.10 - 12.10)
