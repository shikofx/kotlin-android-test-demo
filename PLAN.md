...
*   [x] **Задачи по CI/CD (GitHub Actions & GitLab CI):*
    *   [x] **Интеграция с Allure Report:**
        *   [x] Добавлен плагин Allure в Gradle.
        *   [x] Настроен пайплайн в **GitHub Actions** для генерации Allure-отчета и его публикации на **GitHub Pages**.
        *   [x] Настроен пайплайн в **GitLab CI** для генерации Allure-отчета и его публикации на **GitLab Pages**.
    *   [x] **Настройка JaCoCo:**
        *   [x] Интегрирован JaCoCo в Gradle для сбора покрытия кода тестами.
        *   [x] Добавлена в CI-пайплайны задача для генерации отчета JaCoCo и сохранения его как артефакта.
    *   [x] Обновлена `pages` job в GitLab для включения отчетов о покрытии и Allure в общий отчет.
