...
*   [ ] **Задачи по CI/CD (GitLab CI):**
    *   **Развертывание GitLab:**
        *   [x] Зарегистрировано доменное имя и настроена A-запись.
        *   [x] Установлен GitLab (Community Edition) на арендованном сервере с помощью Docker.
        *   [x] Выполнен первый вход и смена пароля администратора.
        *   [x] Настроен локальный SSH-клиент для работы с нестандартным портом GitLab.
        *   [x] Созданы пользователи и проект в GitLab.
        *   [x] Настроен локальный репозиторий для одновременной работы с GitHub и GitLab (`multi-remote`).
    *   **Подготовка образа:**
