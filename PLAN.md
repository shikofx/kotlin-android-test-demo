...
## Этап 2: Модульное тестирование, Allure TestOps и сбор покрытия (01.10 - 08.10)
...
*   [ ] **Задачи по коду:**
    *   [ ] Написать первые Unit-тесты для бизнес-логики (`SingletonClass.Methods`), используя **JUnit 5**.
...
*   [ ] **Задачи по CI/CD (GitLab CI):**
    *   **Настройка JaCoCo:**
        ...
        *   [ ] Добавить в `.gitlab-ci.yml` задачу для генерации отчета JaCoCo и сохранения его как артефакта.
        *   [ ] Обновить `pages` job для включения отчета о покрытии в общий отчет на GitLab Pages.
    *   **Интеграция с Allure:**
        *   [ ] Добавить плагин Allure в Gradle.
        *   [ ] Настроить пайплайн для отправки результатов тестов (Unit) и отчетов (JaCoCo, статический анализ) в Allure TestOps.
